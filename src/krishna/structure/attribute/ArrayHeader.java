...
import krishna.structure.attribute.formats.HeaderReader;
import krishna.structure.attribute.formats.RsesHeaderReader;
...
public class ArrayHeader implements Header
{
     ...
     * @throws IOException if an I/O error has occured.
     */
    public ArrayHeader(HeaderReader hr) throws IOException
    {
        initialize(hr);
    }
